...
import { TakuProvider } from '@/components/taku/TakuProvider'
import TakuDock from '@/components/taku/TakuDock'

/**
 * El provider de Taku envuelve al Outlet: cualquier vista puede hacerlo hablar
 * o reaccionar con useTaku(), y el dock lo dibuja una sola vez para toda la
 * app en vez de que cada pantalla monte su propia mascota.
 */
